...
class ProjectProposalState(StrEnum):
    ...
    EVALUATED = "EVALUATED"
    READY_FOR_STRATEGIC_GATE = "READY_FOR_STRATEGIC_GATE"
    STRATEGIC_GATE_APPROVED = "STRATEGIC_GATE_APPROVED"
    STRATEGIC_GATE_REJECTED = "STRATEGIC_GATE_REJECTED"
    STRATEGIC_GATE_DEFERRED = "STRATEGIC_GATE_DEFERRED"
    CANCELLED = "CANCELLED"
    ARCHIVED = "ARCHIVED"
